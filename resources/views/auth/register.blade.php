                ...
                <div class="row h-100vh align-items-center background-white">
                    ...
                    <div class="col-md-5 col-sm-12 h-100" id="login-responsive">                
                        <div class="card-body pr-10 pl-10 pt-10">
                            ...
                            <!--fahad arshad    -->
                                <div class="input-box mb-4  d-flex ">
                                <div class="flex-grow-1 mr-2">
                                
                                  <label for="name" class="fs-12 font-weight-bold text-md-right">{{ __('First Name') }}</label>
                                  <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="off" autofocus placeholder="{{ __('First Name') }}">
                                  @error('name')
                                  ...
                                  <label for="last_name" class="fs-12 font-weight-bold text-md-right">Last Name</label>
                                    <input id="last_name" type="text" class="form-control " name="last_name" value=""off" autofocus placeholder="Last Name">
                                    </div>                 
                                </div>
                            ...
                            <!--fahad arshad    -->
                                ...
                                <div class="input-box mb-4 ">                             
                                    ...
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"  name="email" value="{{ old('email') }}" autocomplete="off"  placeholder="{{ __('Email Address') }}" style="background :#202528;" required>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <!--</div>-->
                                    ...
                                    .input-box1 {
                                      width: calc(50% - 15px); /* adjust the width to your preference */
